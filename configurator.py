...
class configurations:
    ...
    def get_address_ground_to_air(self, new_address_ground_to_air):
    ...
    def get_address_air_to_ground(self, new_address_air_to_ground):
